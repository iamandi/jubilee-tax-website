...
const NavbarContactHeader = () => {
    ...
    return (
        <header id="header" className="headroom navbar-color-white navbar-style-four" style={{ backgroundColor: '#1e314b' }}>
...
export default NavbarContactHeader;